...
| Linux 6.6.0 arm64, virtme-ng/QEMU | System suite: 13 examples, 0 failures, 3 expected pending (`statmount` and its 6.8-only boundary cases). |
...
regressions. Run the system suite on 5.15, 6.1, 6.6, and 6.12 before publishing
a release.
